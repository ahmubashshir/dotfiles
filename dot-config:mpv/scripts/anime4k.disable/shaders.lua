...
-- Anime4K: unset
shaders["none"] = {}
-- Anime4K: < 480p (Faithful)
shaders["lq_faithful"] = {
    "Upscale_CNN_M_x2_Denoise", "Auto_Downscale_Pre_x4", "Auto_Downscale_Pre_x4"
}
...
-- Anime4K: < 480p (Perceptual Quality)
shaders["lq_perceptual"] = {
    "Upscale_CNN_M_x2_Denoise", "Auto_Downscale_Pre_x4", "DarkLines_HQ",
...
-- Anime4K: < 480p (Perceptual Quality and Deblur)
shaders["lq_deblur"] = {
    "Upscale_CNN_M_x2_Denoise", "Auto_Downscale_Pre_x4", "Deblur_DoG",
    "DarkLines_HQ", "ThinLines_HQ", "Upscale_CNN_UL_x2_Deblur"
}
